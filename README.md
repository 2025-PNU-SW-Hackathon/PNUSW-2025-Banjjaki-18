...
<img width="1032" height="504" alt="image" src="https://github.com/user-attachments/assets/2de08943-1bbb-4996-945b-fbe19e06e9fe" />
...
<img width="1150" height="393" alt="image" src="https://github.com/user-attachments/assets/f0f5c198-80da-499a-8231-6199bf5f1083" />
...
<img width="990" height="503" alt="image" src="https://github.com/user-attachments/assets/463d24fa-bad2-4768-b2b7-bcfd6b27e2ac" />
...
<img width="814" height="351" alt="image" src="https://github.com/user-attachments/assets/7f6d721b-c947-49f4-a1ad-8c02b763c9e1" />
...
- **예상 수익**
  - 3~5년 차에는 연 30억 원 이상, 최대 40억 원 규모 광고 매출 가능.
...
**(1) 1년차: 핵심 기능 출시 및 안정화, 초기 유저 확보**

- **핵심 목표**
  - 플랫폼 초기 버전 출시 및 주요 기능 안정화
  - 파일럿 운영을 통해 사용자 피드백 수집 및 서비스 개선
- **기술·기능**
  - 지원사업 통합 확인 기능 구현
  - RAG AI 기반 추천 기초 모델 개발
  - 신청서 작성 보조 기능 탑재
- **영업·마케팅**
  - 부산 지역 소규모 자영업자 대상 파일럿 진행
  - SNS·커뮤니티를 통한 저비용 홍보
- **전략적 제휴**
  - 지자체·NGO와의 시범 협력 체결
  - 사회적 신뢰도 제고 및 초기 서비스 수요 창출

**(2) 2년차: 맞춤화 강화, 추천 정확도 향상**

- **핵심 목표**
  - 전국 단위 서비스 확장
  - 추천 정확도 고도화 및 자동화 기능 강화
- **기술·기능**
  - AI 추천 엔진 개선
  - 지원사업 자동 수집·신청서 자동화 기능 고도화
  - 재도전 지원·맞춤 알림 기능 추가
- **영업·마케팅**
  - 전국 단위 서비스 홍보 범위 확대
  - 전국 단위 시연 기회 확대 및 브랜딩 강화
- **전략적 제휴**
  - 세무·법률 전문가 네트워크 구축
  - 정책 기관과의 공식 협력 확대

**(3) 3년차: 데이터 기반 의사결정 지원, 서비스 다각화**

- **핵심 목표**
  - 데이터 기반 리포트·분석 서비스 제공
  - 정책 문서 분석 및 AI 질의응답 기능 출시
- **기술·기능**
  - 정책 문서 자동 분석 기능
  - 폐업·재창업 리포트 생성 모듈 구축
- **영업·마케팅**
  - 폐업 지원 기관 제휴를 통한 홍보 채널 확보
  - 전국 단위 시연 기회 확대 및 브랜딩 강화
- **전략적 제휴**
  - 창업보육센터 및 정책 기관과 협약 체결
  - 재무·세무 솔루션 기업과 패키지형 서비스 출시

**(4) 4년차: B2B/B2G 확대, 전략적 데이터 활용**

- **핵심 목표**
  - B2B·B2G 파트너 확장
  - 데이터 기반 공공·기업 맞춤 보고서 제공
- **기술·기능**
  - 정책 효과 분석 모듈 개발
  - 지역별 폐업·재창업 트렌드 분석 기능
  - B2B 대시보드 제공
- **영업·마케팅**
  - 지자체·정부·기업 대상 데이터 패키지 제공
  - 미디어 PR 강화로 공공 신뢰도 제고
- **전략적 제휴**
  - 데이터 플랫폼 기업과 협력
  - **조달청 등록**을 통한 공공조달 시장 진입

**(5) 5년차: 창폐업 통합 플랫폼 완성, 재창업 연결**

- **핵심 목표**
  - 폐업–재창업 통합 지원 플랫폼 구축
  - AI 기반 재창업 추천 및 맞춤 금융·컨설팅 연계
- **기술·기능**
  - AI 재창업 추천 엔진 고도화
  - 맞춤 창업 정책·금융·컨설팅 연계 기능
  - 재창업 일정·데이터 분석 연동 서비스
- **영업·마케팅**
  - 창업 지원 기관과 연계한 공동 프로그램 운영
  - 창업보육센터 파트너십 강화
  - “폐업 → 재창업” 브랜딩 캠페인 진행
- **전략적 제휴**
  - 지자체·공공기관·금융사·인큐베이터 통합 연계
  - 폐업자 재취업 및 직업 재교육 지원 기관과 공식 파트너십 체결
...
<img width="1128" height="528" alt="image" src="https://github.com/user-attachments/assets/34b537b6-a3ba-4504-9b68-875875f6426b" />
